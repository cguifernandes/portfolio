...
const SideBar = () => {
	...
	return (
		<>
			...
			<animated.div
				style={animation}
				className="fixed top-0 right-0 w-64 pb-6 p-4 justify-between bg-neutral-900/60 flex flex-col backdrop-blur-md min-h-screen border-l-2 border-t-2 border-neutral-800 z-50"
			>
