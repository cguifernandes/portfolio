      ...
      <div class="flex p-3 lg:pl-5 w-full flex-col gap-y-4 flex-1">
        <div class="flex flex-col max-w-2xl mx-auto lg:m-0 xl:max-w-4xl gap-y-4 pr-3">
          <div class="flex gap-x-4 items-center justify-center lg:justify-normal">
            <img :src="MyImage" alt="My Image" class="xl:size-12 transition-all duration-200 border border-neutral-800 dark:border-neutral-200 size-10 object-cover rounded-full" />
        ...
        <div class="flex flex-col gap-y-2">
          ...
          <div class="flex flex-wrap max-h-60 gap-3 overflow-x-auto pr-2 custom-scrollbar">
            <SkillsCard
              :is-traslate="true"
