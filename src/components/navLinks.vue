<template>
  <a
    ...
    class="py-2 px-3 dark:hover:bg-grey-700 duration-200 rounded-lg cursor-pointer text-neutral-800 hover:bg-neutral-300 dark:text-grey-100 hover:text-blue-500"
  >
    <font-awesome-icon
